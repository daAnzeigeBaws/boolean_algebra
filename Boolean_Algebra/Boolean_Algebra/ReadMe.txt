========================================================================
    KONSOLENANWENDUNG: Boolean_Algebra-Projektübersicht
========================================================================

Diese Boolean_Algebra-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Boolean_Algebra-Anwendung besteht.


Boolean_Algebra.vcxproj
...
Boolean_Algebra.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Boolean_Algebra.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
